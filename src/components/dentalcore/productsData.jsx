...
const img = {
  ...
  uccut_unit:         resolveImage('UC_CUT_Gutta_Purcha_Cutter_Unit_1006-1.jpg'),
  uccut_unit_tip:     resolveImage('UC_CUT_Gutta_Purcha_Cutter_Unit+Tip_1006-1.jpg'),
  uccut_closeup:      resolveImage('UC_CUT_Gutta_Purcha_Cutter_Unit_1006-1_Close-up.jpg'),
  uccut_tip_included: resolveImage('UC_CUT_Gutta_Purcha_Cutter_Tip_1006-1-U.jpg'),
  uccut_info:       resolveImage('UC_CUT_Gutta_Purcha_Cutter_INFO_1006-1.png'),
  uccut_all_tips:   resolveImage('UC_CUT_Gutta_Purcha_Cutter_ALL_Tips.png'),
  uccut_stand:      resolveImage('UC_CUT_Stand_1006-9.png'),
  uccut_full_alt:   resolveImage('UC Cut - Full Device.jpg'),
  ...
  ucone_info2:      resolveImage('UC_ONE_INFO_2.png'),
  ucone_tips_info:  resolveImage('UC_ONE_TIPS_INFO.png'),
  ucone_unit_info:  resolveImage('UC_ONE_UNIT_INFO.png'),
  ...
  ep_cure_black:      resolveImage('EP_CURE_Black_1007-2.png'),
  ep_cure_wb:         resolveImage('EP_CURE_White_Black.png'),
  ep_mini_white:      resolveImage('EP_CURE_MINI_White_1008-1.png'),
  ep_mini_black:      resolveImage('EP_CURE_MINI_Black_1008-1.png'),
  ep_mini_green:      resolveImage('EP_CURE_MINI_Green_1008-1.png'),
  ep_mini_info:       resolveImage('EP_CURE_MINI_INFO.png'),
...
export const products = [
  ...
  // =========================================
  {
    ...
    description: "Cordless sonic GP cutter with rapid heat-up and vibration-assisted removal. Choose the handpiece unit or the Full Kit with bundled accessories.",
    longDescription: "UC-CUT is designed for chairside gutta-percha cutting without a bulky electrosurgery unit. The cordless handpiece combines rapid heat-up with sonic vibration to shear GP cleanly at the canal orifice, giving you consistent results during obturation and retreatment procedures.\n\nSelect the Handpiece Unit for the core device, or the Full Kit when you want tips and accessories bundled in one order. Interchangeable tips let you match the right profile to your case.",
    image: img.uccut,
    images: uniqueImages(
      img.uccut,
      img.uccut_unit_tip,
    ...
    variants: [
      ...
      },
      {
        ...
        name: 'Full Kit',
        price: 878.99,
        image: img.uccut_info,
      },
    ],
    features: [
      "Cordless, rechargeable operation for full operatory mobility",
      "Rapid heat-up for efficient GP trimming at the canal orifice",
      "Sonic vibration assists clean separation without excessive force",
      "Interchangeable tips for posterior, anterior, and specialty use",
      "Compact, lightweight handpiece for long procedures",
      "No cart or corded unit required",
    ],
    specs: {
      "SKU": "1006-1",
      "Includes": "UC-CUT handpiece",
      "Tips": "Sold separately — multiple tip profiles available",
      "Primary use": "Gutta-percha cutting and removal during obturation / retreatment",
      "Power": "Cordless rechargeable",
      "Sterilization": "Metal tips autoclavable per IFU; handpiece surface disinfection / barrier",
    },
    faqs: [
      { question: "What is UC-CUT used for?", answer: "UC-CUT is a cordless sonic gutta-percha cutter used to trim and remove GP during obturation and retreatment. It combines rapid heat with sonic vibration for clean separation at the canal orifice." },
      { question: "Does UC-CUT come with tips?", answer: "This listing includes the UC-CUT handpiece. Tips are sold separately so you can choose the profiles that fit your workflow — options include standard, posterior, anterior, and specialty tips." },
      { question: "Are UC-CUT tips autoclavable?", answer: "Metal tips in the UC-CUT system are designed to be autoclavable per manufacturer guidance. The handpiece should be barrier-protected and surface-disinfected — follow the IFU for your specific tip model." },
      { question: "Who is UC-CUT best for?", answer: "Endodontists and general practitioners who want cordless heat and vibration for obturation and GP removal without a large electrosurgery cart." },
      { question: "How should UC-CUT be maintained?", answer: "Follow the manufacturer instructions for cleaning and maintenance. Use proper barrier technique on the handpiece and autoclave compatible metal tips per IFU." },
      { question: "How long does shipping take?", answer: "Orders submitted on a business day are typically processed the same day and shipped the next business day. Most US orders arrive within 3-10 business days after shipment." },
      { question: "Does UC-CUT have a warranty?", answer: "Warranty follows manufacturer terms for defects in materials and workmanship. Contact Coretix sales for support." },
      { question: "Can UC-CUT be returned?", answer: "Returns are evaluated case-by-case. Contact sales before returning. Opened or sterile items may not be eligible." },
    ],
    sources: [
      { label: "Coretix UC-CUT product page", url: "https://www.dentalcoreinstruments.com/p/uc-cut" },
      { label: "Coretix shipping and returns policy", url: "https://www.dentalcoreinstruments.com/policies" },
  ...
  },
  {
    ...
    price: 658.99,
    category: "Endodontics",
    description: "Cordless ultrasonic irrigator that activates irrigant deep into canal anatomy for more effective debris and biofilm removal during endodontic treatment. Choose the handpiece unit or the Full Kit with tips and stand included.",
    longDescription: "UC-ONE is designed for clinicians who want a cordless, handheld way to ultrasonically activate sodium hypochlorite, EDTA, or other approved irrigants inside the root canal system. Ultrasonic energy creates acoustic streaming that drives irrigant into lateral canals, fins, and isthmuses. Use only irrigants and settings consistent with manufacturer directions and your training.\n\nSelect the Handpiece + Stand option for the core unit, or the Full Kit to bundle the handpiece with a complete tip set (Body, Short, Long, Endo) and tip stand in one box.",
    image: img.ucone,
    images: uniqueImages(
      img.ucone,
      img.ucone_dual,
    ...
    variants: [
      {
        id: '1002-1',
        name: 'Handpiece + Stand',
        price: 658.99,
        image: img.ucone,
      },
      {
        id: '1002-Full-Kit',
        name: 'Full Kit (tips + stand)',
        price: 768.99,
    ...
    features: [
      ...
      "Includes handpiece and charging stand \u2014 tips sold separately",
    ],
    specs: {
      "SKU": "1002-1",
      "Includes": "UC-ONE handpiece + charging stand",
      "Tips": "Sold separately \u2014 or choose the Full Kit for a bundled tip set",
      ...
      "Sterilization": "Handpiece surface disinfection / barrier per manufacturer IFU",
    },
    faqs: [
      { question: "Does UC-ONE come with tips?", answer: "This unit listing includes the handpiece and charging stand. Plastic and metal tips are available as separate add-ons, or you can order the UC-ONE Full Kit which includes the handpiece, tip set (Body, Short, Long, Endo), and tip stand." },
      { question: "What is the difference between the Unit and the Full Kit?", answer: "The Unit includes the UC-ONE handpiece and charging stand. The Full Kit adds a complete tip set (Body, Short, Long, Endo) and a tip stand \u2014 everything you need to get started in one box." },
      { question: "Is there an official UC-ONE overview video?", answer: "Yes \u2014 check the video section on this page for a clinical overview walkthrough." },
      { question: "What does UC-ONE do during root canal treatment?", answer: "UC-ONE ultrasonically activates irrigants inside the canal to improve cleaning and debris removal as part of a complete irrigation protocol." },
      { question: "Is UC-ONE a replacement for needle irrigation?", answer: "No. Needle irrigation and canal preparation remain essential. UC-ONE adds ultrasonic activation alongside conventional delivery." },
      { question: "Which irrigants can I use with UC-ONE?", answer: "Use irrigants approved for intracanal use and compatible with the device per manufacturer instructions \u2014 commonly sodium hypochlorite and EDTA." },
      { question: "Who is UC-ONE best for?", answer: "UC-ONE is designed for licensed dental teams performing endodontic procedures who want a cordless activation option in their irrigation workflow." },
      { question: "How should UC-ONE be cleaned and maintained?", answer: "Follow the manufacturer instructions for cleaning and maintenance. Use proper barrier technique and sterilization for compatible accessories." },
      { question: "How long does shipping take?", answer: "Orders submitted on a business day are typically processed the same day and shipped the next business day. Most US orders arrive within 3-10 business days after shipment." },
      ...
      { question: "Can UC-ONE be returned?", answer: "Returns are evaluated case-by-case. Contact sales before returning. Opened or sterile items may not be eligible." },
    ],
    sources: [
      { label: "Coretix UC-ONE product page", url: "https://www.dentalcoreinstruments.com/p/uc-one" },
      { label: "Coretix shipping and returns policy", url: "https://www.dentalcoreinstruments.com/policies" },
  ...
  // =========================================
  {
    ...
    faqs: [
      ...
      { question: "What is the shipping timeline for this SKU?", answer: "Orders submitted on a business day are typically processed the same day and shipped the next business day. Most US orders arrive within 3-10 business days after shipment." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How long does shipping usually take?", answer: "Orders submitted on a business day are typically processed the same day and shipped the next business day. Most US orders arrive within 3-10 business days after shipment." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How long does shipping typically take?", answer: "Orders submitted on a business day are typically processed the same day and shipped the next business day. Most US orders arrive within 3-10 business days after shipment." },
  ...
  },
  {
    ...
    features: [
      ...
      "Autoclavable light guide tip (134\u00b0C)",
      "Cordless and rechargeable",
      "Charge and buffer indicator lights",
    ...
    specs: {
      ...
      "Output": "1,200 mW/cm\u00b2",
      "Wavelength": "465nm",
      "Cure modes": "5-second / 3-second",
      "Tip sterilization": "Autoclavable at 134\u00b0C",
      "Power": "Cordless rechargeable",
      "Colors": "White, Black, Green",
    },
    faqs: [
      { question: "What cure modes does EP CURE MINI have?", answer: "EP CURE MINI has two modes: a 5-second standard mode and a 3-second fast mode. Always follow the composite manufacturer\u2019s recommended cure times for your specific material and increment thickness." },
      { question: "Is the tip autoclavable?", answer: "Yes. The EP CURE MINI light guide tip is autoclavable at 134\u00b0C per the manufacturer IFU." },
      { question: "What colors is EP CURE MINI available in?", answer: "EP CURE MINI is available in White, Black, and Green. Select your preferred color when ordering." },
      { question: "What is the light output?", answer: "EP CURE MINI delivers 1,200 mW/cm\u00b2 at 465nm, which is suitable for curing most light-activated composites and bonding agents per manufacturer recommendations." },
      { question: "Who is EP CURE MINI best for?", answer: "Dentists and hygienists looking for a compact, lightweight curing light for everyday restorative procedures who want a cordless option with fast cure modes." },
      { question: "How long does shipping take?", answer: "Orders submitted on a business day are typically processed the same day and shipped the next business day. Most US orders arrive within 3-10 business days after shipment." },
      { question: "Does EP CURE MINI have a warranty?", answer: "Warranty follows manufacturer terms for defects in materials and workmanship. Contact Coretix sales for support." },
      { question: "Can EP CURE MINI be returned?", answer: "Returns are evaluated case-by-case. Contact sales before returning. Opened or sterile items may not be eligible." },
    ],
    sources: [
      { label: "Coretix EP CURE MINI product page", url: "https://www.dentalcoreinstruments.com/p/ep-cure-mini" },
      { label: "Coretix shipping and returns policy", url: "https://www.dentalcoreinstruments.com/policies" },
      { label: "Request EP CURE MINI IFU", url: "mailto:sales@dentalcoreinstruments.com" },
    ],
  },
  {
    id: "M1001",
