...
export const products = [
  ...
  },
  {
    ...
    discoveryHeading: "Why practices add ultrasonic activation",
    discoveryParagraph:
      "Needle irrigation alone often leaves irregular canal anatomy under-challenged. A cordless ultrasonic activator like UC-ONE helps move irrigant in tight curves and fins when used as part of a complete volume-and-exchange protocol\u2014so teams standardize on safer, more predictable cleaning steps before obturation. The Full Kit bundles the handpiece with tips and stand so you can start treating on day one.",
    features: [
      "Cordless design for easy access to all quadrants",
      "Ultrasonic activation of canal irrigants per clinical protocol",
      "Helps disrupt debris and biofilm when paired with adequate irrigation volume",
      ...
      "Rechargeable operation for repeat use through the day",
      "Streamlined body for chairside handling alongside your file sequence",
      "Includes UC-ONE handpiece, tip set (Body, Short, Long, Endo), and tip stand",
      "Additional plastic and metal tips available separately for replacements",
    ],
    specs: {
      "SKU": "1002-Full Kit",
      "Includes": "UC-ONE handpiece + tip set (Body, Short, Long, Endo) + tip stand",
      "Additional tips": "Plastic and metal tips available separately for replacements",
      "Intended use": "Ultrasonic irrigation / irrigant activation in root canals",
      "Power": "Cordless rechargeable",
      "Compatibility": "Standard endodontic access; use with approved irrigants only",
      "Sterilization": "Tips and accessories per manufacturer IFU; handpiece surface disinfection / barrier",
    },
    faqs: [
      { question: "What is included in the UC-ONE Full Kit?", answer: "The Full Kit includes the UC-ONE cordless handpiece, a complete tip set (Body, Short, Long, Endo profiles), and a tip stand. Everything you need to start using ultrasonic irrigation right away." },
      { question: "What is the difference between the Unit and the Full Kit?", answer: "The Unit includes only the UC-ONE handpiece and charging stand \u2014 tips sold separately. The Full Kit bundles the handpiece with a complete tip set and tip stand in one box." },
      { question: "Can I order replacement tips later?", answer: "Yes. Plastic disposable tips and metal tips are available as separate add-ons whenever you need replacements." },
      { question: "Is there an official UC-ONE overview video?", answer: "Yes \u2014 check the video section on this page for a clinical overview walkthrough." },
      { question: "What does UC-ONE do during root canal treatment?", answer: "UC-ONE ultrasonically activates irrigants inside the canal to improve cleaning and debris removal as part of a complete irrigation protocol." },
      { question: "Is UC-ONE a replacement for needle irrigation?", answer: "No. Needle irrigation and canal preparation remain essential. UC-ONE adds ultrasonic activation alongside conventional delivery." },
      { question: "Which irrigants can I use with UC-ONE?", answer: "Use irrigants approved for intracanal use and compatible with the device per manufacturer instructions \u2014 commonly sodium hypochlorite and EDTA." },
    ...
    sources: [
      { label: "Coretix UC-ONE Full Kit product page", url: "https://www.dentalcoreinstruments.com/p/uc-one-full-kit" },
      { label: "Coretix shipping and returns policy", url: "https://www.dentalcoreinstruments.com/policies" },
      { label: "CDC dental infection prevention guidance", url: "https://www.cdc.gov/oral-health/hcp/infection-control/index.html", note: "Reference for clinical infection-control standards." },
      { label: "Request UC-ONE IFU from Coretix sales", url: "mailto:sales@dentalcoreinstruments.com", note: "Request current manufacturer instructions and accessory handling details." },
    ],
