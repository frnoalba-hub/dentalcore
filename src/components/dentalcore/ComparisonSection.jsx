    ...
    <section className="relative py-32 px-6 lg:px-12 bg-[#0a0a0a]">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="h-full p-8 bg-gray-900 rounded-2xl border border-gray-800 hover:border-cyan-500/50 transition-all duration-300">
                <div className="flex items-start gap-4">
                  {/* Icon */}
                  <div className="flex-shrink-0 p-3 bg-cyan-500/10 rounded-xl border border-cyan-500/20 group-hover:bg-cyan-500/20 group-hover:scale-110 transition-all duration-300">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="p-8 lg:p-10 bg-gradient-to-br from-cyan-500/5 to-transparent rounded-2xl border border-cyan-500/20 text-center">
