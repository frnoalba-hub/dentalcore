...
export default function AboutSection() {
  const { aboutContent, businessInfo } = useContentStore();
  ...
  return (
    <section id="about" className="relative py-32 px-6 lg:px-12 bg-[#050505] overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        >
          <span className="text-cyan-400 font-semibold tracking-wider text-sm uppercase mb-2 block">{aboutContent.tagline}</span>
        ...
        >
          <div className="p-10 lg:p-14 bg-gray-900 rounded-3xl border border-gray-800">
            <div className="relative z-10 space-y-6 text-center max-w-3xl mx-auto">
              ...
              {aboutContent.paragraphs.length > 1 && <div className="w-full h-px bg-gray-800 my-8" />}
            </div>
          </div>
        </motion.div>
