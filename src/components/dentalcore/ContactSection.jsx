...
export default function ContactSection() {
  return (
    <section id="contact" className="relative bg-slate-900 overflow-hidden">
      ...
      <div className="py-20 lg:py-28 px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <span className="text-amber-400 font-semibold tracking-[0.15em] text-xs uppercase mb-3 block">Get in Touch</span>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <motion.a
              ...
              className="group bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-amber-500/30 hover:bg-white/[0.07] transition-all duration-300"
            >
              <div className="flex items-start justify-between mb-6">
                ...
                <ArrowUpRight className="w-5 h-5 text-white/10 group-hover:text-amber-400 transition-all" />
              </div>
              <p className="text-xs text-white/30 uppercase tracking-widest font-semibold mb-2">Email Support</p>
              <p className="text-lg font-semibold text-white/80 group-hover:text-amber-300 transition-colors">{companyInfo.email}</p>
            </motion.a>
            ...
            >
              ...
              <p className="text-lg font-semibold text-white/80 group-hover:text-amber-300 transition-colors">{companyInfo.phone}</p>
            </motion.a>
          </div>
        </div>
      </div>
      ...
      {/* Footer */}
      <div className="border-t border-white/5 py-8 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-amber-500 rounded-lg flex items-center justify-center font-bold text-slate-900 text-sm">D</div>
