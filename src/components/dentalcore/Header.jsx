      ...
      <div className="w-full px-6 lg:px-12">
        <div className="h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            >
              <span className="text-sm font-medium tracking-wide uppercase hidden sm:block">Cart</span>
          ...
          >
            <nav className="flex flex-col p-6 gap-6">
              ...
              <div className="mt-8 pt-8 border-t border-[#111]/10 flex flex-col gap-4">
                <a href={`tel:${companyInfo.phone}`} className="text-sm uppercase tracking-wide text-[#111]/60">
                  {companyInfo.phone}
                </a>
